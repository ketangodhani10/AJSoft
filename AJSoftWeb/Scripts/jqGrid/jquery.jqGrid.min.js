	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				//pgl += "<td id='" + po[0] + "' class='ui-pg-button ui-corner-all' " + (ts.p.pgfirst ? "title='" + ts.p.pgfirst + "'" : "") + "><span class='fa fa-angle-left fa-lg'></span>&nbsp;</td>";
				//pgl += "<td id='" + po[1] + "' class='ui-pg-button ui-corner-all' " + (ts.p.pgprev ? "title='" + ts.p.pgprev + "'" : "") + "><span class='fa fa-angle-double-left fa-lg'></span>&nbsp;</td>";
				//pgl += pginp !== "" ? sep + pginp + sep : "";
				//pgl += "<td id='" + po[2] + "' class='ui-pg-button ui-corner-all' " + (ts.p.pgnext ? "title='" + ts.p.pgnext + "'" : "") + "><span class='fa fa-angle-double-right fa-lg'></span>&nbsp;</td>";
				//pgl += "<td id='" + po[3] + "' class='ui-pg-button ui-corner-all' " + (ts.p.pglast ? "title='" + ts.p.pglast + "'" : "") + "><span class='fa fa-angle-right fa-lg'></span>&nbsp;</td>";
			...
			buildRuleMenu = function( elem, left, top ){
				...
				for ( i = 0 ; i < options.sopt.length; i++) {
					...
					if(ina !== -1) {
						...
						str += '<li class="ui-menu-item ' + selclass + '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + p.odata[ina].oper + '" oper="' + p.operands[p.odata[ina].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="15px" style="padding:0 5px;font-family: Open Sans;font-size: 10px;">' + p.operands[p.odata[ina].oper] + '</td><td style="padding:0 5px; font-family: Open Sans;font-size: 10px;">' + p.odata[ina].text + '</td></tr></table></a></li>';
					}
				}
				str += "</ul>";
				$('body').append(str);
